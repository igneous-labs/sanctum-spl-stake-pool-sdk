...
/// - PDAs can't be found
#[wasm_bindgen(js_name = decreaseAdditionalValidatorStakeIxFromStakePool)]
pub fn decrease_additional_validator_stake_ix_from_stake_pool(
    ...
    let accounts = stake_pool_sdk::DecreaseAdditionalValidatorStakeIxKeysOwned::default()
    ...
    let data = stake_pool_sdk::DecreaseAdditionalValidatorStakeIxData::new(
        args.lamports,
        args.transient_stake_seed,
    )
    .to_buf();
    ...
    Ok(Instruction {
        ...
        accounts: Box::new(
            DecreaseAdditionalValidatorStakeIxKeysHandle(accounts).to_account_metas(),
        ),
...
#[wasm_bindgen]
#[derive(Default)]
pub struct DecreaseAdditionalValidatorStakeIxKeysHandle(
    stake_pool_sdk::DecreaseAdditionalValidatorStakeIxKeysOwned,
);

impl DecreaseAdditionalValidatorStakeIxKeysHandle {
    fn to_account_metas(
        &self,
    ) -> [AccountMeta; stake_pool_sdk::DECREASE_ADDITIONAL_VALIDATOR_STAKE_IX_ACCS_LEN] {
        keys_signer_writer_to_account_metas(
            &self.0.as_borrowed().0,
            &stake_pool_sdk::DECREASE_ADDITIONAL_VALIDATOR_STAKE_IX_IS_SIGNER.0,
            &stake_pool_sdk::DECREASE_ADDITIONAL_VALIDATOR_STAKE_IX_IS_WRITER.0,
        )
    }
}
